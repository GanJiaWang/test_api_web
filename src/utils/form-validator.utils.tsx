...
export const minCheckBox = (min: number) => (value: string | any[]) =>
  value && value.length < min ? `Must be ${min} selected checkbox` : undefined;
...
export const phoneNumber = (value: string) =>
  value && /^(\+?6?01)[0|1|2|3|4|6|7|8|9]-*[0-9]{7,8}$/.test(value) ? undefined : 'Invalid phone number';
